...
<body id="page-top">
    ...
    ?>
                ...
                <span class="sr-only">Loading...</span>
                    ...
                    <div class="modal hide fade modal-form" id="add_radar" tabindex="-1" role="dialog" aria-labelledby="add_radar_title" aria-hidden="true" data-backdrop="static" data-keyboard="false">
