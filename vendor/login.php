...
$db = mysql_select_db("user_db_connection.php", $connection); // Selecting Database
if (isset($_POST['name1'])) {
$query = mysql_query("insert into form_element(name,password) values ('$name2', '$email2', '$password2','$contact2')"); //Insert Query
