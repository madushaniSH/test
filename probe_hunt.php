...
<div class="row">
    ...
    <button class="btn" id="continue_btn" data-toggle="modal" data-target="#add_probe"><i class="fas fa-chevron-circle-right fa-3x"></i><br>Continue</button>
    </div>
</div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="add_probe_title">Title</h5>
