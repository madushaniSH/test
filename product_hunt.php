...
<a href=\"export_projects.php\" class=\"btn btn-lg dashboard-btn\">
    <span>
...
<a href=\"https://www.youtube.com/watch?v=ZmH4-UwHP3Y\" class=\"btn btn-lg dashboard-btn\">
    <span>
...
if($_SESSION['role'] === 'Admin' || $_SESSION['role'] === 'Supervisor' || $_SESSION['role'] === 'SRT Analyst'){
    echo"
<a href=\"probe_qa.php\" class=\"btn btn-lg dashboard-btn\">
    <span>
