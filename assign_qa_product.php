...
$probe_info = $stmt->fetch(PDO::FETCH_OBJ);
$return_arr[] = array("brand_name" => $probe_info->brand_name, "client_category_name" => $probe_info->client_category_name , "product_type"=>$probe_info->product_type, "product_name"=>$probe_info->product_name, "product_alt_design_name"=>$probe_info->product_alt_design_name);
