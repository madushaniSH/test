...
$sql = 'SELECT project_error_id FROM project_errors WHERE project_error_name = :project_error_name LIMIT 1';
$stmt = $pdo->prepare($sql);
$stmt->execute(['project_error_name'=>trim($_POST['error_new_name'])]);
$error_id  = $stmt->fetchColumn();

$return_arr[] = array("error"=>$error, "error_id" => $error_id);
