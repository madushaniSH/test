...
for ($i = 0; $i < $count_projects; $i++) {
    ...
    $hunter_summary[$i]["Brand Hunted"] = 0;
    $hunter_summary[$i]["SKU Hunted"] = 0;
    $hunter_summary[$i]["DVC Hunted"] = 0;
    $hunter_summary[$i]["Hunted Facing Count"] = 0;
    $hunter_summary[$i]["Checked Probe Count"] = 0;
    $hunter_summary[$i]["Radar Link Count"] = 0;
    $hunter_summary[$i]["Checked Reference Count"] = 0;
    $hunter_summary[$i]["Disapproved Products"] = 0;
    $hunter_summary[$i]["Rename Errors"] = 0;
    $hunter_summary[$i]["System Errors"] = 0;
    $hunter_summary[$i]["QA Errors"] = 0;
    $hunter_summary[$i]["Accuracy"] = 0;
    $pdo = NULL;
}
